                            ...
                            )
{
    ...
    if (count > 0)
    {
            ...
            (bs_extension_type == EXT_SBR_DATA_CRC))
        {
            ...
            {
                hDecoder->sbr[sbr_ele] = &hDecoder->sbr_array[sbr_ele];
				sbrDecodeInit(hDecoder->sbr[sbr_ele], hDecoder->frameLength,
                                   ...
                                   bitfile *ld, program_config *pce, drc_info *drc)
{
    ...
    if ((hDecoder->sbr_present_flag == 1) && (hDecoder->object_type == DRM_ER_LC))
    {
        ...
        if (!hDecoder->sbr[0])
        {
            hDecoder->sbr[0] = &hDecoder->sbr_array[0];
			sbrDecodeInit(hDecoder->sbr[0], hDecoder->frameLength, hDecoder->element_id[0],
