...
typedef struct
{
    ...
    */
	...
	real_t time_out_array[MAX_CHANNELS][AAC_FRM_LEN * 2];
    real_t *time_out[MAX_CHANNELS];
    //real_t *fb_intermed[MAX_CHANNELS];
    real_t fb_intermed[MAX_CHANNELS][AAC_FRM_LEN];
    ...
    sbr_info sbr_array[MAX_SYNTAX_ELEMENTS];
    ...
    pred_state pred_stat[MAX_CHANNELS][AAC_FRM_LEN];
#endif
#ifdef LTP_DEC
    //int16_t *lt_pred_stat[MAX_CHANNELS];
    int16_t lt_pred_stat[MAX_CHANNELS][AAC_FRM_LEN * 4];
#endif
