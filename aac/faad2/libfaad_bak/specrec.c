...
//#ifdef LTP_DEC
...

    {
        ...
        hDecoder->time_out[channel] = hDecoder->time_out_array[channel];
    ...
    if (output_channels == 2)
    {
        ...
        hDecoder->time_out[channel+1] = hDecoder->time_out_array[channel+1];
...
//#ifdef LTP_DEC
    ...
    if (hDecoder->time_out[paired_channel] == NULL)
    {
        ...
        hDecoder->time_out[paired_channel] = hDecoder->time_out_array[paired_channel];
                                   ...
                                   element *sce, int16_t *spec_data)
{
        ...
        && hDecoder->sbr_alloced[hDecoder->fr_ch_ele])
    {
        ...
        {
            hDecoder->sbr[ele] = &hDecoder->sbr_array[ele];
			sbrDecodeInit(hDecoder->sbr[ele], hDecoder->frameLength,
