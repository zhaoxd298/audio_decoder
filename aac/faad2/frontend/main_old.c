                         ...
                         float *song_length)
{
	...
	printf("<%s:%d> NeAACDecOpen()\n", __func__, __LINE__);
	hDecoder = NeAACDecOpen();

	/* Set the default object type and samplerate */
	/* This is useful for RAW AAC files */
	printf("<%s:%d> NeAACDecGetCurrentConfiguration()\n", __func__, __LINE__);
	...
	printf("<%s:%d> NeAACDecSetConfiguration()\n", __func__, __LINE__);
	...
	*song_length = length;
	...
	printf("<%s:%d> fill_buffer()\n", __func__, __LINE__);
	fill_buffer(&b);
	printf("<%s:%d> NeAACDecInit()\n", __func__, __LINE__);
...
#undef BUILD_DATE
	...
	else
	{
		...
		printf("\n<%s:%d> aacFileName:%s\n", __func__, __LINE__, aacFileName);
		printf("<%s:%d> audioFileName:%s\n", __func__, __LINE__, audioFileName);
		printf("<%s:%d> adtsFileName:%s\n", __func__, __LINE__, adtsFileName);
		printf("<%s:%d> writeToStdio:%d\n", __func__, __LINE__, writeToStdio);
		printf("<%s:%d> def_srate:%d\n", __func__, __LINE__, def_srate);
		printf("<%s:%d> object_type:%d\n", __func__, __LINE__, object_type);
		printf("<%s:%d> outputFormat:%d\n", __func__, __LINE__, outputFormat);
		printf("<%s:%d> format:%d\n", __func__, __LINE__, format);
		printf("<%s:%d> downMatrix:%d\n", __func__, __LINE__, downMatrix);
		printf("<%s:%d> infoOnly:%d\n", __func__, __LINE__, infoOnly);
		printf("<%s:%d> adts_out:%d\n", __func__, __LINE__, adts_out);
		printf("<%s:%d> old_format:%d\n", __func__, __LINE__, old_format);
