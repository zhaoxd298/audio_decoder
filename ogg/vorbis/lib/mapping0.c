...
static int mapping0_inverse(vorbis_block *vb, vorbis_info_mapping *l)
{
	...
	//printf("pcm0:%f/%f/%f/%f/%f/%f/%f/%f\n", vb->pcm[0][0], vb->pcm[0][1], vb->pcm[0][2], vb->pcm[0][3], 
	//	vb->pcm[0][4], vb->pcm[0][5], vb->pcm[0][6], vb->pcm[0][7]);
	...
	for (i = 0; i < info->submaps; i++)
	{
		...
		//printf("pcm2:%f/%f/%f/%f/%f/%f/%f/%f\n", vb->pcm[0][0], vb->pcm[0][1], vb->pcm[0][2], vb->pcm[0][3], 
		//	vb->pcm[0][4], vb->pcm[0][5], vb->pcm[0][6], vb->pcm[0][7]);
		
		// vb->pcm[0] set data in this function
		_residue_P[ci->residue_type[info->residuesubmap[i]]]->
			inverse(vb, b->residue[info->residuesubmap[i]],
			        pcmbundle, zerobundle, ch_in_bundle);
	}
	
	//printf("pcm3:%f/%f/%f/%f/%f/%f/%f/%f\n", vb->pcm[0][0], vb->pcm[0][1], vb->pcm[0][2], vb->pcm[0][3], 
	//	vb->pcm[0][4], vb->pcm[0][5], vb->pcm[0][6], vb->pcm[0][7]);
	...
	//printf("pcm5:%f/%f/%f/%f/%f/%f/%f/%f\n", vb->pcm[0][0], vb->pcm[0][1], vb->pcm[0][2], vb->pcm[0][3], 
	//	vb->pcm[0][4], vb->pcm[0][5], vb->pcm[0][6], vb->pcm[0][7]);

	//int *ptr = (int *)vb->pcm[0];
	//printf("pcm5:%d/%d/%d/%d/%d/%d/%d/%d\n", ptr[0], ptr[1], ptr[2], 
	...
	{
		float *pcm = vb->pcm[i];		
		int *ptr = (int *)vb->pcm[i];	// ah test
		for (j=0; j<vb->pcmend; j++)
		{
			ptr[j] = FLOAT_CONV(pcm[j]);
		}
		
		//printf("pcm5:%d/%d/%d/%d/%d/%d/%d/%d\n", ptr[0], ptr[1], ptr[2], 
		//	ptr[3], ptr[4], ptr[5], ptr[6], ptr[7]);
		mdct_backward(b->transform[vb->W][0], ptr, ptr);
	}

	//printf("pcm6:%f/%f/%f/%f/%f/%f/%f/%f\n", vb->pcm[0][0], vb->pcm[0][1], vb->pcm[0][2], vb->pcm[0][3], 
	//	vb->pcm[0][4], vb->pcm[0][5], vb->pcm[0][6], vb->pcm[0][7]);
